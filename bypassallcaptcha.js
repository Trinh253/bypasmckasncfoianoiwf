...
// Change Your Delay in the settings options from 5 to 10 or 20 if you have issues like Your action marked Suspicious,Don't try to bypass ,Don't use Speedster, etc
   ...
   params: {Announcements : {type: 'text', default: 'Enable Always Ready if You Open Multiple Tabs'},
    reCAPTCHA: {label: "Auto Open Recaptcha", type: "checkbox", default: true,},
    hCaptcha: { label: "Auto Open Hcaptcha", type: "checkbox", default: true, },
    Turnstile: {label: "Auto Open Turnstile", type: "checkbox", default: true,},
    YTShort: {label: "Disable Youtube Short", type: "checkbox", default: true,},
    RightFC: {label: "Enable Context Menu ", type: "checkbox", default: true,},
    BlockFC: {label: "Enable Always Ready", type: "checkbox", default: true,},
    TimerFC: {label: "Enable Fast Timer ", type: "checkbox", default: true,},
    SetDelay: {label: "Redirect Delay ", type: "number", default: 30,},},});
